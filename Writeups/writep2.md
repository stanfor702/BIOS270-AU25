...
$micromambda install -n environment name -c channel_name package_name
...
The r-based Bioconductor packages that were installed in the  bioinfo_example environment were as follows: 
